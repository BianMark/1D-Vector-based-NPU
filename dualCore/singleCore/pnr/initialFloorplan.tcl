...
#    sramin: 150*150
#    sramout: 250*250
floorPlan -site core -s 800 800 50.0 50.0 50.0 50.0
...
setObjFPlanBox Instance qmem_instance 40 150 190 300
#flipOrRotateObject -rotate R90 -name qmem_instance
#flipOrRotateObject -flip MY -name qmem_instance

setObjFPlanBox Instance kmem_instance 140 150 290 300
#flipOrRotateObject -rotate R90 -name kmem_instance
#flipOrRotateObject -flip MY -name kmem_instance



setObjFPlanBox Instance qmem_instance 152.23 617.554 332.23 797.554

setObjFPlanBox Instance kmem_instance 155.008 401.8135 335.008 581.8135

setObjFPlanBox Instance psum_mem_instance 454.809 101.718 734.809 381.718
